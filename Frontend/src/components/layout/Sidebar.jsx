...
export function Sidebar({ links = [], user, onMobileItemClick }) {
  ...
  return (
    <aside className={cn(
      "h-full flex flex-col py-6 transition-all duration-500 relative z-50 border-r border-white/5",
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-48 h-48 bg-amber-500/5 blur-[80px] rounded-full"></div>
      </div>
