...
export function Scheduling() {
  ...
  return (
    <div className="w-full relative">
      {/* Header */}
      <header className="glass-card-pro border-b border-white/5 sticky top-0 z-40 bg-black/40 backdrop-blur-xl flex justify-between items-center h-20 px-4 md:px-8 -mt-4 md:-mt-8 md:mx-[-24px] lg:mx-[-32px] w-full md:w-[calc(100%+48px)] lg:w-[calc(100%+64px)] mb-8">
        <div className="absolute top-0 right-10 w-48 h-48 bg-emerald-500/10 blur-[100px] rounded-full"></div>
        <div className="flex items-center gap-6 relative z-10">
          <h2 className="font-bold text-2xl md:text-3xl text-white">Interview Scheduling</h2>
        </div>
      </header>
