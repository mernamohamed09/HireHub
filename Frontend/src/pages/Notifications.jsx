...
export function Notifications() {
  ...
  return (
    <div className="w-full relative">
      {/* Header Section */}
      <header className="glass-card-pro border-white/5 border-b border-white/10 sticky top-0 z-40 -mt-4 md:-mt-8 mx-[-16px] md:mx-[-24px] lg:mx-[-32px] px-4 md:px-8 py-6 flex flex-col gap-4 mb-8 bg-background/80 backdrop-blur-xl">
        <div className="absolute top-0 right-10 w-48 h-48 bg-emerald-400/10 blur-[100px] rounded-full"></div>
        <div className="flex flex-col sm:flex-row justify-between sm:items-center w-full relative z-10 gap-4 sm:gap-0">
          <div className="flex items-center gap-4">
            <h1 className="font-bold text-2xl md:text-3xl text-white">Notifications</h1>
            {unreadCount > 0 && (
          ...
          <button
            onClick={markAllRead}
            className="flex items-center gap-2 text-emerald-300 text-sm font-bold hover:text-white transition-all group self-start sm:self-auto"
          >
